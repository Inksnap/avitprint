// =================== ****************** ================== //
// Template Name: Print Hive
// Description:  Print Hive Html Template
// Version: 1.0.0
...
(function (window, document, $, undefined) {
  ...
  var Init = {
    ...
    methods: function (e) {
      ...
      Init.header();
      Init.slick();
      Init.countdownInit2(".countdown-card", "2026/11/11");
       Init.slick();
    ...
    header: function () {
      ...
      $(window).on("scroll", function () {
        ...
        if ($("header").length) {
          ...
          var stricky = $("header");
          if ($(window).scrollTop() > headerScrollPos) {
            stricky.addClass("bg-white z-100 position-fixed top-0 w-100");
          } else {
            stricky.removeClass("bg-white z-100 position-fixed top-0 w-100");
          }
        }
      });
